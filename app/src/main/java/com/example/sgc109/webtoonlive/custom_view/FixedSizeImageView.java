...
//    private boolean isLastPosition = false;
    private int cutWidth = 600;
    private int cutHeight = 1600;
...
//        Log.d("mydebug", "not last!!");
        setMeasuredDimension(width, ((int) (width * ((float)cutHeight / cutWidth))));
//        } else {
//            Log.d("mydebug", "last!!");
...
//    }
    public void setCutSize(int cutWidth, int cutHeight) {
