package com.example.sgc109.webtoonlive.util;
...
public class SharedPreferencesService implements Serializable {
    private static final String SHARED_PREFS_CONFIGURATION = "RealTimeWebtoon";
